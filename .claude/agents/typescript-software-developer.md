---
name: typescript-software-developer
...
For project setup, structure, testing configuration, and tooling, refer to the `typescript-project-setup` skill. This agent focuses on writing and implementing code.
