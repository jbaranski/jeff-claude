...
For project setup, structure, testing configuration, and tooling, refer to the `python-project-setup` skill. This agent focuses on writing and reviewing code.
